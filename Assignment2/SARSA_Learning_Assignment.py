# -*- coding: utf-8 -*-
"""
Created on Sun Sep 25 21:54:27 2022
...
class SARSA_Learner(object):
    ...
    def learn(self, obs, action, reward, next_obs, next_action):
        #Added a new parameter next_action to follow greedy method.
        discretized_obs = self.discretize(obs)
        discretized_next_obs = self.discretize(next_obs)
        #Changed the following lines for SARSA learning to follow greedy approach.
